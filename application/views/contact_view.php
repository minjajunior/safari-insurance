...
<div class="page">
    ...
    <section class="section-30 section-md-40 section-lg-66 section-xl-bottom-90 bg-gray-dark page-title-wrap" style="background-image: url(<?php echo base_url('assets/images/bg-image-8.jpg')?>);">
        <div class="container">
        ...
        <div class="container">
            <div class="row justify-content-lg-between row-60">
                <div class="col-lg-7 col-xl-6">
                    ...
                    <form class="rd-mailform form-modern" data-form-output="form-output-global" data-form-type="contact" method="post" action="https://livedemo00.template-help.com/wt_prod-12802/bat/rd-mailform.php">
                    ...
                    <div class="inset-lg-right-15 inset-xl-right-0">
                        <div class="row row-30">
                            <div class="col-md-10 col-lg-12">
                                ...
                                <p class="text-black">
                                    If you have any questions, just fill in the contact form, and we will answer you shortly. If you are living nearby, come visit Safari Insurance Limited at one of our comfortable offices
                                </p>
                            </div>
                            <div class="col-md-6 col-lg-12">
                                ...
                                <address class="contact-info">
                                    <p class="text-uppercase text-black">
                                        <b>Safari Insurance Limited,</b>
                                        Plot N0. 2203-5/32, Block No. 106,<br>
                                        1st Floor Tancot House, Sokoine Drive,<br>
                                        P. O. Box 76619,<br>
                                        Dar es Salaam,<br>
                                    </p>
                                    <dl class="list-terms-inline">
                                        <dt>Telephone</dt>
                                        <dd><a class="link-black" href="tel:#">+255 22 2110535</a></dd>
                                    </dl>
                                    <dl class="list-terms-inline">
                                        <dt>E-mail</dt>
                                        <dd><a class="link-primary" href="#">info@safariinsurance.co.tz</a></dd>
                                    </dl>
                                </address>
                            </div>
                            <div class="col-md-6 col-lg-12">
